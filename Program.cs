...
");
        ...
        public static void go()
        {
            string[] args;
            string input;
            Console.WriteLine("\n Welcome to interactive SharpSQL, a <barely modified at all> spinoff of mlsec's SharpSQL.\nWhich can be found at https://github.com/mlcsec/SharpSQL/tree/main/SharpSQL");
            Console.WriteLine("Please note, that every command has to have must have an -Instance except for Get-SQLInstanceDomain.\n Please type -help if you need it.");
            do
            {
                Console.Write("SharpSQL $>");
                input = Console.ReadLine();
                args = input.Split(null);
